...
capacity = 2000  # 2000张图片
train_epochs = 1504  # 迭代次数
...
# 获取训练数据及标签
train_b, train_label_b = get_batch(train, train_label, img_W, img_H, batch_size, capacity)
# 获取测试数据及标签
test_b, test_label_b = get_batch(test, test_label, img_W, img_H, batch_size, capacity)
print("reading batch...")
#  训练操作定义
